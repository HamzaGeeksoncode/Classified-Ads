            ...
            <div class="modal-dialog modal-dialog-centered mw-650px">
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body scroll-y mx-5 mx-xl-10 my-7">
                        <!--begin::Form-->
                        <form class="form fv-plugins-bootstrap5 fv-plugins-framework" action="{{ route('adpost.update') }}" method="POST">
                            @csrf
                            <!--begin::Scroll-->
                            <div class="d-flex flex-column scroll-y me-n7 pe-7" data-kt-scroll="true"
                                ...
                                <div class="fv-row mb-7 fv-plugins-icon-container">
                                    ...
                                    <select name="status" id="adpost_status" class="form-control form-control-solid mb-3 mb-lg-0" required>
            ...
            <table id="kt_datatable_example_5"
                ...
                <tbody>
                    @foreach ($post as $key => $data)
                        <tr>
                            <td>{{ ++$key }}</td>
                            <td><img src="{{ asset('public/adpost/features/image/' . $data->feature_image) }}"
                            ...
                            @hasrole('admin')
                                <td>
                                    <i class="bi bi-clipboard-plus p-6 text-success post_status" data-id="{{ $data->id }}" style="font-size:16px !important"></i>
                                </td>
                            @endhasrole
                        </tr>
                    @endforeach
